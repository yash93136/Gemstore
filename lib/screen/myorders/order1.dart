          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: const [
                  Text(
                    'Your order is delivered', // Changed text
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: 18,
                  ...
                  SizedBox(height: 5),
                  Text(
                    'Rate product to get 5 points for collect.', // Changed text
                    style: TextStyle(
 ...
 Widget _buildActionButtons(BuildContext context) {
    return Row(
      children: [
        ...
        // "Rate" button - smaller
        Expanded(
          flex: 3, // Gives it half the space of the "Return home" button
          child: ElevatedButton(
            onPressed: () {
              // Handle "Rate"
              Navigator.push(context, MaterialPageRoute(builder: (context) =>  RateProductScreen()));
